...
export var Synth = function(json, setTimeout) {
  this.setTimeout = setTimeout ||
    (typeof window === 'object' && window.setTimeout && window.setTimeout.bind(window)) || // eslint-disable-line no-undef
    (typeof global === 'object' && global.setTimeout && global.setTimeout.bind(global)); // eslint-disable-line no-undef
...
Synth.Tremolo = function(unused_sound, unused_array) {
};
...
Synth.Envelope.prototype.run = function(sound, array, startSample, endSample) {
  ...
  if (attack === 0 && sustainPunch == 0 && decay === 0) {
    return;
  }

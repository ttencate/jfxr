  ...
  new Preset({
    ...
    applyTo: function(sound) {
      ...
      do {
        ...
        (sound.lowPassCutoff.value > sound.highPassCutoff.value) &&
        (sound.lowPassCutoff.value + sound.lowPassCutoffSweep.value > sound.highPassCutoff.value + sound.highPassCutoffSweep.value)
      );
